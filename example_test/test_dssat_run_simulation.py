...
DEM_PATH     = "data_test/guadalupe_dem.tif"   # set to None to skip DEM and use elevation=0
...
if __name__ == "__main__":
    ...
    # DEM elevations (optional — uses 0 m if DEM_PATH is None or file is absent)
    if DEM_PATH and os.path.exists(DEM_PATH):
        print("\nSampling DEM elevations...")
    else:
        print("\nNo DEM provided — using elevation = 0 m for all pixels.")
