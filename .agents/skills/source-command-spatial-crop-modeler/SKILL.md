---
name: "source-command-spatial-crop-modeler"
...
# source-command-spatial-crop-modeler

Use this skill when the user asks to run the migrated source command `spatial-crop-modeler`.
